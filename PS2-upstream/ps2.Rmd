...
**We may see more difference among the results if sample size were smaller. The result from RI would be more trustworthy in that case. With a larger sample size and normally ditributed outcomes, the difference in p values may not be much**
