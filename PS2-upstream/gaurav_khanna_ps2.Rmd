...
p_two_texas
``` 
**Answer: p value for ATE for Texas is 0.0863**
...
p_two_arkansas
```
**Answer: p value for ATE for Arkansas is 0.0028**
...
**p value from (f)(Randomization inference): .0058**
...
**We may see more difference among the results if sample size were smaller. The result from RI would still be more trustworthy (due to the influence of sample size and normality on regression). With a larger sample size and normally ditributed outcomes, the difference in p values may not be much**
