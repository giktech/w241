...
**Answer: Clusters in the study are composed of similar individuals: with the same age, gender and location**
**The members of above clusters have very little variance in study relevant attributes: age, gender, location but there's significant variance between the clusters. When assigned as a group, this assignment suppresses the variance in Y leading to a smaller estimate for errors. When we take clustering into account, we correct for this, leading to bigger SE's.**
...
** The p value is close to 0 (7.344e-09)**
...
**Answer: The "recycling bin with sticker" has a stronger treatment effec. The magnitude of the difference is (.055 - .035 = .020) .020**
...
**If the estimates err in opposite directions (-.015 in one case and +.015 in the other) there could be cases where the difference in the outcomes (.020 for the point estimates) would reduce to 0**
...
lr4f.confint["bin",]
```
**Answer: The 95% confidence interval of the treatment effect with "no cell" as the co-variate is [0.08166792 0.14853357] without the interaction term**
**Answer: The 95% confidence interval of the treatment effect with "no cell" as the co-variate is [0.08108329 0.16826147] with the interaction term**
**The confidence interval almost matches the previous one as having a cell phone (or not) does not explain any of the variance in the primary treatment effect (bin). The variables are not correlated. The correlation charts and the coefficient for the interation term [-0.02310269(0.03440852)] show the same**
**TBD**
...
**Answer: The 95% confidence interval with SMS included in the regression is [0.08160886 0.14849843] without the interaction term**
**The 95% confidence interval with SMS included in the regression is [0.06936329 0.14994262] with the interaction term**
**The confidence interval does not change again as "sms" does not explain any of the variance/noise in the treatment effect. SMS and bin are fairly independent.**
...
# TBD: Do we not need an interaction term? Assuming not as we are trying to reproduce the results of table 4B
...
1. The treatment effect of Bin without Sticker is: 1.031902e-01 (2.188886e-02)
2. The treatment effect of Bin with Sticker is is: 1.278129e-01 (2.223628e-02)
3. The treatment effect of generic SMS is: 0.01970712 (0.02519764)
4. The treatment effect of specific SMS is: -0.008041152  (0.025036933)

**Answer: The 95% confidence interval with generic recycling bin is [0.06025627 0.14612416 ]**
**The confidence interval is a little tighter from that in part (g). The increased precision comes by breaking the "bins" variable into more precise "bin_g" and "bin_s". "bin_s" (bins with stickers) is able to explain some of the variance that was earlier in the confidence interval for "bin". **
*** 
...
**Answer: TBD:The coefficient/ATE is -0.16554(0.07567)**
...
**TBD AIC.....confidence interval has also gone down**
