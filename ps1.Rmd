...
Answer: This denotes the average (Expectation) of potential treatment outcome when a subject is selected randomly from subjects that are not exposed to the treatment.
