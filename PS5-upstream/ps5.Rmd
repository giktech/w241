...
**One way to improve the analysis would be to treat the prior week's sales as a baseline and a co-variate in the analysis. This separates the impact of baseline behavior from what is caused by the exposure to treatment ads**    
