...
```
**Answer: TBD The distribution seems reasonable. Everyone in the study as 0-6 exposures to any ad. The distribution looks normal. Each of the exposure could be on an even or odd second. On even second a participant would see the "treatment" ad**
...
summary(lr1b)
```
### We are suspicious. Running a placebo test. First picking folks who saw no treatment ads but saw other ads as the placebo group
```{r}
# Picking people with 0 treatment ad exposure but > 0 total add exposure
...
summary(lr2a)
```
**Answer: The naive regressions suggests that every  year of additional education causes a $5750.48(83.34) bump in income. The regression also shows a very confident result and significant result (the SE is almost 1/50th of the impact)**
...
**Answer: A story could be that "years of education" is not really a cause, but an effect of other causal factors like wealth in the family, education in the family and the environment. These causal factors have a positive impact on wealth and "years of education" in a very similar way. An example could be a teenager raised in an academic family that also provides seed funds to startups. This teenager would be expected to go to college and can also use some of the family wealth and connections to create more**
...
```
** A skew towards lower income in both the groups**
...
**Answer: The vast difference in the number of observations for low draft numbers is concerning. It could be a sign of differential attrition (higher attrition in the "high draft" group) can can bias our estimate**
...
Answer: The experiment measures the impact of plate size on the amount of food consumed. That direct impact is easy to observe, measure and believe in. ** The leap from that conclusion to the broader and more general conclusion about "weight management ~ plate size" is difficult to believe.**  
**Weight and Weight control is a fairly complex topic and is effected by a lot of personal and environmental variables. Generalizing it from an observation on quantity of food may not be accurate**
