...
**Answer: The estimated CACE would add information on the impact of the treatment, on actual subjects that were treated i.e. is the real effect of the treatment. If we calculate the average effect over all the subjects in the treatment group (ATE), we make an implicit assumptions that the treatment effect for "never takers" is 0, which is inaccurate, and could lead to an underestimate of the treatment effect**
...
**Answer: The population of compliers is more important for future decision making. That's where the information on real effect of the treatment comes from. Nothing on the actual treatment effect is contributed by the "never takers"**
**There may be one reason to briefly look at "never takers". It is to get a idea of the ratio of the 2 groups in the overall population. This may be useful in some experiments where its hard to know if the treatment was carried out completely**
...
**In this specific example, we'll concentrate on ITT if we're trying to measure the effectiveness of 1> reaching people and 2> converting those we reach to voters**
**We'll concentrate on CACE if our concern is limited to measure the reate of turnout for those that we are able to contact (2> above)**
