...
**Answer: Yes, the data suggests that Never Takers in treatment and placebo groups have the same rate of turnout. Yes, the comparison is informative. It validates the similarity of the groups. It also assures that without the treatment and placebo actions, the turnout remains close to the baseline**
...
**Answer: The CACE estimate from the placebo groupo is .027. This supports our assuption that the placebo has no effect on the turnout**  
...
```
**Answer: The CACE estimate for the treatment group is 0.144**  
...
```
**Answer: CACE for the treatment group by comparing with compliers in placebo group is 0.0921. A 9.2% uplift in the turnout is significant when compared to the baseline. It means that ~9% more folks show up for voting from the group that answers the door, and gets the encouragement to vote **  
...
**TBD: Answer: The rate of complience in this study is low, ~ 18%**
