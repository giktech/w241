...
# Is in control? 
dz0 <- c(rep(0, 6))
# Is in treatment? Compliars and NT's
...
# ATE for each
exp.df$ate <- exp.df$yd1 - exp.df$yd0
exp.df
...
```
**Answer: With the DF above, we get an ATE of .166 and the CACE of -.667**
...
**Answer: The estimated CACE would add information on the impact of the treatment, on subjects that were "actually" treated i.e. is the real effect of the treatment. If we calculate the average effect over all the subjects in the treatment group (ATE), we make an implicit assumptions that the treatment effect for "never takers" is 0, which is inaccurate, and could lead to an underestimate of the treatment effect**
...
**Answer: The population of compliers is more important for future decision making. That's where the information on real effect of the treatment comes from. Nothing on the "actual" treatment effect is contributed by the "never takers". This is true for most experiment on the efficacy of drugs**
...
**Answer: The exaggerated reports make the canvassers' efforts seem less effective (Lower estimate for CACE)**
**Effectiveness** can be defined in terms of either ITT or CACE. We could either define it as an increasing +ve value (greater than 0) for the ITT or a positive value greater than ITT for CACE.
**The definition matters as forces us to recognize exactly what we want to measure before the expriment.**
**In this specific example, we'll concentrate on ITT if we're trying to measure the effectiveness of 1> Trying to reach out to people or knocking on doors and 2> Talking to folks who open the door after the knock**
**We'll concentrate on CACE if our concern is limited to measure the effect on turnout for those that we are able to contact (2> above)**
